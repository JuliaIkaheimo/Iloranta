...
return (
  <View style={styles.container}>
    ...
    {pickedLocation ? 
        <View>
          <Text>Time: {pickedLocation.timestamp}</Text>
          <Text>LAT: {pickedLocation.coords.latitude}</Text>
          <Text>LNG: {pickedLocation.coords.longitude}</Text>
          <Text>ALT: {pickedLocation.coords.altitude}</Text>
          <Text>ACC: {pickedLocation.coords.accuracy}</Text>
